...
namespace CardApi.Controllers
{
    ...
    public class CardsController : ControllerBase
    {
        ...
        //get  card
        [HttpPost]
        public async Task<IActionResult> AddCard([FromRoute] Card card)
        {
        ...
        public async Task<IActionResult> UpdatrCard([FromRoute] Guid id, [FromRoute] Card card)
        {
            var existingCard = await cardsDbContext.Cards.FirstOrDefaultAsync(x => x.Id == id);
            if(existingCard != null)
            {
                existingCard.CardOlderName= card.CardOlderName;
